...
import 'package:multiplatform_app/screens/Admin/event_tab/event_detail.index.dart';
...
class EventCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.to(EventDetail(hrefs: hrefs, id: id, name: name, desc: desc, startTime: startTime, endTime: endTime, address: address, content: content));
      },
      child: Padding(
